...
![](image/project11_jenkins_Ansible_rename.png)
2. In your GitHub account create a new repository and name it ansible-config-mgt.  

![](image/project11_git_repo.png)
...
![](image/project11_jenkins_AnsibleInstall.png)  
...
![](image/project11_jenkinsJob_.png) 

![](image/project11_ansiblewebhook_.png)  

![](image/project11_ansiblewebhook2_.png)  

![](image/project11_auto_build_.png)  
...
![](image/project11_auto_build_ARchiev_verify.png)
...
![](image/project11_Ansible_Directories.png)  
...
````  
![](image/project11_dev_inventory.png)  
...
![](image/project11_playbook_update2.png)
...
![](image/project11_playbook_pullrequest.png)  

![](image/project11_playbook_jenkinsfinal.png
### Step 7 – Run first Ansible test
Execute ansible-playbook command and verify if your playbook actually works:
    - cd ansible-config-mgt
    - ansible-playbook -i inventory/dev.yml playbooks/common.yml 

![](image/project11_playbook_RUn.png)   


![](image/project11_playbook_RUn_updated.png)
